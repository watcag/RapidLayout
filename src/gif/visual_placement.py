...
def draw_png(filename, saveDir):
    ...
    for j in range(len(keys)):
        ...
        if j == 61 :
            drawTileHighlight(ax, sites)
        else:
            drawTiles(ax, sites, '#000000', 0.1)

    # plt.xlabel('evolution iteration = ' + name, fontsize=30)
