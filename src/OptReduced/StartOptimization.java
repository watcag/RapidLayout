...
public class StartOptimization {
    ...
    public Map<Integer, List<Site[]>> main(int block_num, String device,
        ...
        evolutionaryAlgorithmModule.setMu(parents); // number of parentsAreaPerBlock = 14152.666666666666
        ...
        CoolingScheduleModule coolingScheduleModule = new CoolingScheduleModule() {
            ...
            protected void config() {
                bindCoolingSchedule(OptReduced.StartOptimization.CoolingScheduleLinear.class);
        ...
        viewer.setTitle("Placement: " + block_num + "-block");

        Opt4JModule observer = new Opt4JModule() {
            @Override
            protected void config() {
                addOptimizerIterationListener(OptReduced.StartOptimization.monitor.class);
            }
        };
